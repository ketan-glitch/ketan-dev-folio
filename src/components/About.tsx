const About = () => {
  return (
    <section className="py-20 bg-gradient-subtle stars-bg relative">
      {/* Floating cosmic particles */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/5 w-2 h-2 bg-accent rounded-full opacity-50 animate-pulse"></div>
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-primary rounded-full opacity-60 animate-pulse" style={{ animationDelay: "1s" }}></div>
        <div className="absolute top-1/2 right-1/5 w-1.5 h-1.5 bg-secondary rounded-full opacity-40 animate-pulse" style={{ animationDelay: "2s" }}></div>
      </div>
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="card-cosmic rounded-2xl p-8 md:p-12 shadow-cosmic relative overflow-hidden">
            {/* Subtle cosmic glow inside card */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-cosmic rounded-full opacity-10 blur-3xl"></div>
